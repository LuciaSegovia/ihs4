...
Additionally, the mean total consumption is lower than the mean of own production for refined flour for all three regions and remarkably high for "ufa madeya" in the northen region. Similarly higher consumption from own production is shown for green maize with higher contribution in the southern region. 

These results are preliminary as no weights were applied. 
