...
author: 
- "Author - Kevin Tang"
- "Collaborator - Lucia Segovia de la Revilla"
date: "3/3/2020"
...
ihs4 <- ihs4 %>% dplyr::select(id:consYN, item_code, item, item_oth:cons_unitA, cons_unit, unit, cons_unit_oth:gift_unit_size)
