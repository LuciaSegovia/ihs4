...
```{r}
ihs4 <- read.csv("/Users/kevintang/Library/Mobile Documents/com~apple~CloudDocs/Documents/LSHTM/phd epidemiology/2019 2020/data/hces/mwi/ihs2016/hh_mod_g_kg.csv")
```
...
d <- fcode_match %>% select(code, item, item_eng, yield.assumption)
write.csv(d, "/Users/kevintang/Desktop/items_match.csv")
```
