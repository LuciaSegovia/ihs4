...
3. Create a variable selecting the appropitate NSU factor based on the HH reported region
...
```{r}
write.csv(ihs4, here::here("data", "inter-output" , "hh_mod_g_processed.csv"))
```
